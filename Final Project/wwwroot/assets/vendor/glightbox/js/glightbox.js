(function (global, factory) {
  ...
  function injectadminStyle(url, waitFor, callback) {
    if (isNil(url)) {
      console.error('Inject adminStyle error');
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectadminStyle(this.settings.plyr.css, 'Plyr');
    var url = data.href;
    var provider = data === null || data === void 0 ? void 0 : data.videoProvider;
    var customPlaceholder = false;
    slideMedia.style.maxWidth = data.width;
    injectadminStyle(this.settings.plyr.js, 'Plyr', function () {
